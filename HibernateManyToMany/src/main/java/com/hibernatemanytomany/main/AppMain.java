package com.hibernatemanytomany.main;
...
import com.hibernatemanytomany.pojo.Course;
import com.hibernatemanytomany.pojo.Student;
...
public class AppMain {
	...
	public static void main(String[] args) {
		...
		s1.setStudentName("Abhi");
		
		Student s2 = new Student();
		s2.setStudentId(1234);
		s2.setStudentName("Sarvesh");
